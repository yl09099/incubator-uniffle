...
public class RssMRConfig {
  ...
  public static final String RSS_DATA_REPLICA = MR_CONFIG_PREFIX + RssClientConfig.RSS_DATA_REPLICA;
  ...
  public static final String RSS_CLIENT_BITMAP_NUM = MR_CONFIG_PREFIX + "rss.client.bitmap.num";
  ...
  public static final String RSS_ESTIMATE_TASK_CONCURRENCY_DYNAMIC_FACTOR =
      MR_CONFIG_PREFIX + RssClientConfig.RSS_ESTIMATE_TASK_CONCURRENCY_DYNAMIC_FACTOR;
