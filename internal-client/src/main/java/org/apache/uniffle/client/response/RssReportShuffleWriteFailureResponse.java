...
public class RssReportShuffleWriteFailureResponse extends ClientResponse {
  ...
  public ReportShuffleWriteFailureResponse toProto() {
    ReportShuffleWriteFailureResponse.Builder builder = ReportShuffleWriteFailureResponse.newBuilder();
    return builder
  ...
  public static RssReportShuffleWriteFailureResponse fromProto(ReportShuffleWriteFailureResponse response) {
