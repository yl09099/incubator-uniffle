...
public class RssReportShuffleWriteFailureRequest {
  ...
  public RssReportShuffleWriteFailureRequest(String appId, int shuffleId, int stageAttemptNumber,
      List<ShuffleServerInfo> shuffleServerInfos, String exception) {
    this.appId = appId;
  ...
  public ReportShuffleWriteFailureRequest toProto() {
    ...
    for (ShuffleServerInfo shuffleServerInfo : shuffleServerInfos) {
      shuffleServerIds.add(ShuffleServerId.newBuilder()
          .setId(shuffleServerInfo.getId())
          .setPort(shuffleServerInfo.getGrpcPort())
          .setIp(shuffleServerInfo.getHost()).build());
    }
    ReportShuffleWriteFailureRequest.Builder builder = ReportShuffleWriteFailureRequest.newBuilder();
