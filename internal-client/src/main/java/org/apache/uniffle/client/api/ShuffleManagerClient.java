...
public interface ShuffleManagerClient extends Closeable {
  ...
  RssReportShuffleWriteFailureResponse reportShuffleWriteFailure(RssReportShuffleWriteFailureRequest req);

  RssPartitionToShuffleServerResponse getPartitionToShufflerServer(RssPartitionToShuffleServerRequest req);
