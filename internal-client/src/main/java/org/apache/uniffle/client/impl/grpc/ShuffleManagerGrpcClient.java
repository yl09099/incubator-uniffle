...
public class ShuffleManagerGrpcClient extends GrpcClient implements ShuffleManagerClient {
  ...
  public RssReportShuffleWriteFailureResponse reportShuffleWriteFailure(RssReportShuffleWriteFailureRequest request) {
    ReportShuffleWriteFailureRequest protoRequest = request.toProto();
    try {
      ReportShuffleWriteFailureResponse response = getBlockingStub().reportShuffleWriteFailure(protoRequest);
  ...
  public RssPartitionToShuffleServerResponse getPartitionToShufflerServer(RssPartitionToShuffleServerRequest req) {
    ...
    RssProtos.PartitionToShuffleServerResponse partitionToShufflerServer = getBlockingStub()
        .getPartitionToShufflerServer(protoRequest);
    RssPartitionToShuffleServerResponse rssPartitionToShuffleServerResponse = RssPartitionToShuffleServerResponse
        .fromProto(partitionToShufflerServer);
    return rssPartitionToShuffleServerResponse;
  }

  @Override
  public RssReallocationServersReponse reallocationShuffleServers(RssReallocationServersRequest req) {
    RssProtos.ReallocationServersRequest reallocationServersRequest = req.toProto();
    RssProtos.ReallocationServersReponse reallocationServersReponse = getBlockingStub()
        .reallocationShuffleServers(reallocationServersRequest);
