...
public class RssGetReShuffleAssignmentsRequest {
  ...
  @VisibleForTesting
  public RssGetReShuffleAssignmentsRequest(String appId, int shuffleId, int partitionNum,
      int partitionNumPerRange, int dataReplica,
      Set<String> requiredTags, Set<String> shuffleServerIds) {
    this(appId, shuffleId, partitionNum, partitionNumPerRange,
        dataReplica, requiredTags, -1, -1, shuffleServerIds);
  }

  public RssGetReShuffleAssignmentsRequest(String appId, int shuffleId, int partitionNum,
      int partitionNumPerRange, int dataReplica, Set<String> requiredTags, int assignmentShuffleServerNumber,
      int estimateTaskConcurrency, Set<String> shuffleServerIds) {
    this.appId = appId;
